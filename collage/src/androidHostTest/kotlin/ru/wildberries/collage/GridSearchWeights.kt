...
class GridSearchWeights {
    ...
    private fun evalOne(
        ...
        val scorer = DefaultTileFitScorer(weights)
    ...
    private class Grids(
        ...
        val rowLenGrid: Array<RowLengthBias>,
    ...
    private fun buildGrids(): Grids {
        ...
        val rowLenGrid = arrayOf(
            RowLengthBias(enabled = false),
            RowLengthBias(enabled = true, w1 = 0.030, w2 = 0.004, w3 = -0.015, w4 = 0.008)
        )
        ...
        env.outFileAll.printWriter().use { outAll ->
            env.outFileSummary.printWriter().use { outSum ->
                ...
                iterateCombos(grids) { g3, g4, sa, rowLen, eqA, fourMix, rss, lc, lg, cp, gp, hc, mma ->
                    ...
                    val cfg = env.baseCfg.copy(rowLengthBias = rowLen, rowsSearchSpan = rss)
