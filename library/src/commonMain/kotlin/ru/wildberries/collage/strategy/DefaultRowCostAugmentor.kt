...
/**
 * Add global/local penalties and bonuses
 */
internal class DefaultRowCostAugmentor(
    private val widow: CollageTuning.WidowPolicyConfig = CollageTuning.current.augmentor.widow,
    private val penaltyPerExtraHorizontal: Double = CollageTuning.current.augmentor.penaltyPerExtraHorizontal,
    private val penaltyTwoHorizontalsInOneRow: Double = CollageTuning.current.augmentor.penaltyTwoHorizontalsInOneRow,
    private val penaltyThreeHorizontalsInOneRow: Double = CollageTuning.current.augmentor.penaltyThreeHorizontalsInOneRow,
    private val topHeavinessAlpha: Double = CollageTuning.current.augmentor.topHeavinessAlpha,
    private val lastRowTallAlpha: Double = CollageTuning.current.augmentor.lastRowTallAlpha,
    private val firstRowShortAlpha: Double = CollageTuning.current.augmentor.firstRowShortAlpha,
    private val preferThreeVerticalsBonus: Double = CollageTuning.current.augmentor.preferThreeVerticalsBonus,
    private val rowContrastAlpha: Double = CollageTuning.current.augmentor.rowContrastAlpha,
    private val rowWidthBalanceAlpha: Double = CollageTuning.current.augmentor.rowWidthBalanceAlpha,
    private val verticalSquashGuardFracOfWidth: Float = CollageTuning.current.augmentor.verticalSquashGuardFracOfWidth,
    private val verticalSquashAlpha: Double = CollageTuning.current.augmentor.verticalSquashAlpha,
    private val horizontalSquashGuardFracOfWidth: Float = CollageTuning.current.augmentor.horizontalSquashGuardFracOfWidth,
    private val horizontalSquashAlpha: Double = CollageTuning.current.augmentor.horizontalSquashAlpha,
    private val rowHeightSmoothAlpha: Double = CollageTuning.current.augmentor.rowHeightSmoothAlpha,
    private val heightBudgetAlpha: Double = CollageTuning.current.augmentor.heightBudgetAlpha,
    private val stickGamma4: Float = CollageTuning.current.augmentor.stickGamma4,
    private val stickGamma3: Float = CollageTuning.current.augmentor.stickGamma3,
    private val stickPenaltyAlpha: Double = CollageTuning.current.augmentor.stickPenaltyAlpha,
    private val fourMixPenalty: Double = CollageTuning.current.augmentor.fourMixPenalty,
    private val equalizePerRowAlpha: Double = CollageTuning.current.augmentor.equalizePerRowAlpha,
    private val kpAlpha: Double = CollageTuning.current.augmentor.kpAlpha,
    private val kpPower: Double = CollageTuning.current.augmentor.kpPower,
    private val fitnessJumpAlpha: Double = CollageTuning.current.augmentor.fitnessJumpAlpha,
    private val fillAlpha: Double = CollageTuning.current.augmentor.fillAlpha,
    private val tightBuckets: FloatArray = CollageTuning.current.augmentor.tightBuckets,
    private val bonusAlpha: Double = CollageTuning.current.augmentor.bonusAlpha,
    private val allowNegativeTotalPenalty: Boolean = CollageTuning.current.augmentor.allowNegativeTotalPenalty,
    private val bonusRowLenUniformAlpha: Double = CollageTuning.current.augmentor.bonusRowLenUniformAlpha,
    private val bonusRowLenTol: Double = CollageTuning.current.augmentor.bonusRowLenTol,
    private val bonusEqualHeightsAlpha: Double = CollageTuning.current.augmentor.bonusEqualHeightsAlpha,
    private val bonusEqualHeightsTolFrac: Double = CollageTuning.current.augmentor.bonusEqualHeightsTolFrac,
) : RowCostAugmentor {
